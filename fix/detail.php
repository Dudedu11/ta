                    ...
                    <div class="white_card card_height_100 mb_30">
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                ...
                                <right>
                                    <img src="barcode/kode<?php echo $result['id_barang']; ?>.png" alt=""></right>
                            </div>
                        </div>
                        <div class="white_card_body">
                            <div class="QA_section">
                                ...
                                <a href="download.php?file=../barcode/kode<?php echo $result['id_barang']; ?>.png" class="btn_1 mt-1 mb-1">Cetak Barcode</a>
                            </div>
                        </div>
                    </div>
                </div>
