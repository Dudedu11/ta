...
//   $pdf->Ln();
  ...
  $pdf->Ln();
    ...
    if(isset($_GET['cari'])) {
        $cari = $_GET['cari'];
        $data = mysqli_query($conn,"SELECT data_barang.id_barang, data_barang.nama_barang, data_barang.location_asset,data_barang.tahun_pengadaan, data_barang.jenis, data_barang.id_merk, data_barang.kondisi,
        merk.id_merk, merk.nama_merk, count(*) as jumlah_barang
        FROM data_barang
        INNER JOIN merk ON data_barang.id_merk = merk.id_merk 
        where data_barang.kondisi ='Baik'
